...
export function Routes() {
  return (
    <Section
      ...
      surface
      eyebrow="Направления"
      title="Примеры направлений для расчёта"
      intro="Карточки показывают возможные направления, а не публичную оферту. Маршрут, способ перевозки и срок подтверждает менеджер после проверки груза."
    >
