...
const METRICS = [
  { value: 'B2B', unit: 'для российских ООО и ИП' },
  { value: 'CN → RU', unit: 'основное направление' },
  { value: 'онлайн', unit: 'статусы, платежи и чат' },
]
...
const LANES = [
  {
    title: 'Карго',
    note: 'Вариант для отдельных категорий грузов и маршрутов — доступность проверяет менеджер.',
  },
  {
    title: 'Белый импорт',
    note: 'Схема для B2B-поставок с согласованным комплектом документов и условиями ввоза.',
  },
  {
    title: 'Выкуп',
    note: 'Поиск, оплата поставщику и проверка партии могут войти в индивидуальную схему.',
  },
]
      ...
      <div className="relative mx-auto w-full max-w-6xl px-5 pb-12 pt-28 sm:px-8 md:pb-16 md:pt-36">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 max-w-xl text-base leading-relaxed text-white/75 sm:text-lg">
            Сервис помогает согласовать перевозку, вести статусы, платежи и переписку
            в одном месте. Доступная схема, состав услуг, сроки и ответственность
            фиксируются менеджером до отправки груза.
          </p>
